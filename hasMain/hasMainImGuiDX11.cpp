...
int main(int, char**)
{
    ...
    //BRAD////////////////////////////////////
    // Windows typically uses a large icon(e.g., 32x32 or 48x48) for the taskbar and Alt + Tab switcher, 
    // and a small icon(e.g., 16x16) for the window title bar.
    // You can provide separate icons for hIcon and hIconSm if you have different sizes.
    HICON hIcon = LoadIcon(GetModuleHandle(NULL), MAKEINTRESOURCE(IDI_ICON1)); // IDI_MYICON is your icon resource ID
    wc.hIcon = hIcon;
    wc.hIconSm = hIcon;
    //BRAD////////////////////////////////////
